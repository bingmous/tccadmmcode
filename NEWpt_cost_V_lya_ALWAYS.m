...
%     load(strcat('./data/main_lya_PA_data_Vmax_E',num2str(pt-1),'00'))
    load(strcat('./data/main_lya_ALWAYS_data_Vmax_E',num2str(pt-1),'00'))
...
%     load(strcat('./data/main_lya_PA_data_Vmax_E',num2str(pt),'0patch'))
    load(strcat('./data/main_lya_ALWAYS_data_Vmax_E',num2str(pt),'0patch'))
...
cost_delay_V_lya_ALWAYS = cost_delay_V_lya_PA;
save ./data/pt_cost_V_lya_ALWAYS_patch cost_delay_V_lya_ALWAYS 
