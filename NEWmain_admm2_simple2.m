...
%     data_iter_TCC(t) = iter;
end
ts_main_ad=toc(st)
iter_all
    disp(['time:',num2str(ts_main_ad),' total iter:',num2str(iter_all), 'avg iter:', num2str(iter_all/tmax)]);
% save ./data/main_ad2_sim2_data_de
% save ./data/main_ad2_sim2_data_TCC_convergence2
save ./data/main_ad2_sim2_data_pt
