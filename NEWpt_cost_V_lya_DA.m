...
for pt=1:pn
%     load(strcat('./data/main_lya_DA_data_Vmax_E',num2str(pt-1),'00'))
    load(strcat('./data/main_lya_DA_wb_data_Vmax_E',num2str(pt-1),'00'))
    b1=data_lya(1:dc,:);              %ai
...
for pt=0:2:8
%     load(strcat('./data/main_lya_DA_data_Vmax_E',num2str(pt),'0patch'))
    load(strcat('./data/main_lya_DA_wb_data_Vmax_E',num2str(pt),'0patch'))
    b1=data_lya(1:dc,:);              %ai
    b2=data_lya(dc+1:2*dc,:);     %bi
    b3=data_lya(2*dc+1:3*dc,:);  %Di
    b4=data_lya(3*dc+1:4*dc,:);  %ri
...
% save ./data/pt_cost_V_lya_PA_patch cost_delay_V_lya_PA 
cost_delay_V_lya_DA_wb = cost_delay_V_lya_PA;
save ./data/pt_cost_V_lya_DA_wb_patch cost_delay_V_lya_DA_wb 