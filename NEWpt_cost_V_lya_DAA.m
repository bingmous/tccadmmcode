...
%     load(strcat('./data/main_lya_PA_data_Vmax_E',num2str(pt-1),'00'))
    load(strcat('./data/main_lya_DAA_data_Vmax_E',num2str(pt-1),'00'))
    b1=data_lya(1:dc,:);              %ai
...
%     load(strcat('./data/main_lya_PA_data_Vmax_E',num2str(pt),'0patch'))
    load(strcat('./data/main_lya_DAA_data_Vmax_E',num2str(pt),'0patch'))
    b1=data_lya(1:dc,:);              %ai
    b2=data_lya(dc+1:2*dc,:);     %bi
    b3=data_lya(2*dc+1:3*dc,:);  %Di
    b4=data_lya(3*dc+1:4*dc,:);  %ri
...
save ./data/pt_cost_V_lya_DAA_patch cost_delay_V_lya_PA